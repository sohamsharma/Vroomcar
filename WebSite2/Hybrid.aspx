<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Hybrid.aspx.cs" Inherits="Hybrid" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [Hybrid] WHERE ([Name] = @Name)">
        <SelectParameters>
...
&nbsp;<asp:SqlDataSource ID="SqlDataSource4" runat="server" 
            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
            SelectCommand="SELECT [Rate] FROM [Hybrid] WHERE ([Name] = @Name)">
            <SelectParameters>
    ...
    <p>
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
            DataSourceID="SqlDataSource2" Visible="False" DataKeyNames="Name" HorizontalAlign="Center" 
            Width="600px" >
            <Columns>
                <asp:BoundField DataField="Name" HeaderText="Name" SortExpression="Name" />
...
<p>
    ...
    <p>
    <strong style="font-size: xx-large">
        <span style="font-family: Vani; color: #FF6600">Proceed to checkout:</span><span 
        style="font-family: 'Trebuchet MS'; color: #FF6600"> </span>
    </strong>
    <span style="font-family: 'Trebuchet MS'; color: #FF6600">
    <span style="font-size: xx-large">
    <asp:ImageButton ID="ImageButton2" runat="server" BorderStyle="None" 
        ImageUrl="~/images/lightbox-btn-next.gif" PostBackUrl="~/checkout.aspx" 
        Height="16px" Width="34px" onclick="ImageButton1_Click" />
    </span></span>
    </p>
       <br />
    <br />
