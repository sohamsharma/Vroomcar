<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage4.master" AutoEventWireup="true" CodeFile="Booklogin.aspx.cs" Inherits="Booklogin" %>
...
&nbsp;
    ...
    <asp:Panel ID="Panel5" runat="server" Visible="False">
        <div class="txt-center" style="text-decoration: underline">
            <strong style="font-size: xx-large">Luxury<br />
            <br />
            </strong>
        </div>
